...
List1 = ["hello", "you", "future", "billionare"]
List2 = [1, 2, 3]
List3 = ["Yes Sir", 2, 3, True, 5]
...
Songs = ["Bob Dylan", "Like a", "Rolling Stone"]
print(Songs.index("Rolling Stone"))
Songs.insert(0, "1965")
...
print(Beatles.pop(2))
# you can also just use pop since harrison is last on list
